...
const inputVariants = cva(
  "flex h-19 w-full px-8 py-4 focus:outline-none",
  {
    variants: {
      variant: {
        auth: "rounded-[20px] bg-addition-blue-30 border-none text-b6 placeholder:text-addition-blue-80 text-addition-blue-80 font-bold",
